...
public class SandboxListas
{
    ...
    {
        int[] arregloNuevo = new int[listaEnteros.size()];
        for (int i = 0; i < listaEnteros.size(); i++) {
        	arregloNuevo[i] = listaEnteros.get(i);
        }
        return arregloNuevo;
    }
    ...
    {
    	listaEnteros.removeIf(e -> e.equals(valor));
    }
    ...
    public void volverPositivos( )
    {
    	for (int i = 0; i < listaEnteros.size(); i++) {
         ...
         // Si el valor es negativo, se reemplaza por su opuesto
            if(valor < 0 ) {
    ...
    public int contarApariciones( String cadena )
    {
        ...
        for(String string : listaCadenas) {
        	 if (string != null && string.equalsIgnoreCase(cadena)) {
                 contador++;
             }
        }
        return contador;
    ...
    public int contarEnterosRepetidos( )
    {
        ...
        while (i<listaEnteros.size()) {
        	...
        	while (i < listaEnteros.size() && listaEnteros.get(i) == actual) {
                frecuencia++;
                i++;}
