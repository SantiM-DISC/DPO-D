...
public class SandboxMapas
{
    ...
    {
    	List<String> lista = new java.util.LinkedList<>(mapaCadenas.values());
    ...
    {
    	Collection<String> llavesMayus = new java.util.ArrayList<>();
    ...
    {
    	for (Iterator<Map.Entry<String, String>> it = mapaCadenas.entrySet().iterator(); it.hasNext(); ) {
    ...
    public void reiniciarMapaCadenas( List<Object> objetos )
    {
    	 mapaCadenas.clear();
    	   ...
    	   for (Object obj : objetos) {
    	       String valor = (obj != null) ? obj.toString() : "null";
    ...
    public void volverMayusculas( )
    {
    	 Map<String, String> nuevoMapa = new HashMap<>();
    	    ...
    	    for (Map.Entry<String, String> entry : mapaCadenas.entrySet()) {
    	        String llaveMayus = entry.getKey().toUpperCase();
    	        nuevoMapa.put(llaveMayus, entry.getValue());
    	    }
    	  mapaCadenas.clear();
    ...
    public boolean compararValores( String[] otroArreglo )
    {
    	for (String s : otroArreglo) {
            // Si el valor s no se encuentra entre los valores del mapa, retornamos false
            if (!mapaCadenas.containsValue(s)) {
                return false;
            }
        }
        // Si todas las cadenas fueron encontradas en el mapa, retornamos true
        return true;
    }
